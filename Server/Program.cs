...
namespace CourseworkPastPaperApplication2
{
    public class Program
    {
        ...
        private static void MapEndpoints(WebApplication app)
        {
            ...
            app.MapPost("/ValidateTeacher", ValidateTeacher);

            app.MapPost("/SignUpTeacher", SignUpTeacher);
        ...
        private static async Task<Teacher?> GetTeacherById([FromServices] PapersDbContext db, [FromQuery] Guid Id)
        {
