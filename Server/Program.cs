...
namespace CourseworkPastPaperApplication2
{
    public class Program
    {
        ...
        private static async Task<Assignment?> GetAssignmentWith([FromRoute] Guid assignmentId, [FromServices] PapersDbContext db, [FromQuery] bool questions, [FromQuery] bool paperResults)
        {
